...
var pathImg,boyImg,cashImg,diamondsImg,jwelleryImg,swordImg, deadMan_img;
...
function preload(){
  ...
  deadMan_img = loadAnimation("dead man-02 (1).png")
}
...
boy.addAnimation ("dead",deadMan_img)
boy.scale=0.08;
...
function draw() {
 ...
 path.y = height/2;
  ...
  if (gameState===END) {
   ...
   boy.changeAnimation("dead",deadMan_img)
  }
  drawSprites();
}
